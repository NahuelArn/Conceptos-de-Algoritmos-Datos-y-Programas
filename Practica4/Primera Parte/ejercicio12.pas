...
a) la cantidad de galaxias de cada tipo. [v]
b) la masa total acumulada de las 3 galaxias principales (la Vía Láctea, Andrómeda y Triángulo) y el
porcentaje que esto representa respecto a la masa de todas las galaxias. [v]
...
Begin
  For i:= 1 To rango4 Do
    v[i] := 0;
End;
Procedure informarTipo(tipo: trango4);
Begin
  Case tipo Of 
    1: writeln('La galaxia seleccionada es  de tipo eliptica');
    2: writeln('La galaxia es de tipo espiral');
    3: writeln('La galaxia es de tipo lenticular');
    4: writeln('La galaxia es de tipo irregular');
    Else writeln('El tipo de galaxia ingresado no es valido');
  End;
End;
...
Begin
  ...
  readln(rGala.nombre);
  Writeln('Ingrese el tipo de galaxia 1. eliptica; 2. espiral; 3. lenticular 4.irregular: ');
  readln(rGala.tipo);
  informarTipo(rGala.tipo);
...
Begin
  ...
  For i:=  1 To cantGalaxias Do
    ...
    End;
  Writeln('La cantidad de galaxias de tipo elíptica es: ',vCont[1]);
  Writeln('La cantidad de galaxias de tipo espiral es: ',vCont[2]);
  Writeln('La cantidad de galaxias de tipo lenticular es: ',vCont[3]);
  Writeln('La cantidad de galaxias de tipo irregular es: ',vCont[4]);
  ...
  Writeln('La cantidad de galaxias que no es de tipo irregular y esta a menos de 1000pc de la tierra es: ',cantGalaxiaDistancia1000);
